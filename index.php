  ...
  if(fmt==='hls'){
    ...
    if(typeof Hls!=='undefined'&&Hls.isSupported()){
      PL.hls=new Hls({
        ...
        // ── المخزن: بلا حدود عملياً ──
        maxBufferLength:600,              // كان 30 ثانية
        maxMaxBufferLength:1200,          // كان 60 ثانية
        maxBufferSize:0,                  // 0 = بلا حدّ لحجم المخزن (كان 30MB)
        backBufferLength:300,             // كان 30
        maxBufferHole:0.5,
      ...
      PL.hls.on(Hls.Events.ERROR,(e,d)=>{
        ...
        if(d.type===Hls.ErrorTypes.NETWORK_ERROR){
          ...
          try{
            ...
            else if(PL._hlsMediaRetry===3){ PL.hls.swapAudioCodec(); PL.hls.recoverMediaError(); }
